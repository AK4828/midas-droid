...
public class SocialVariable {
    ...
    public static final String DNA_APP_ID = "96c00634-c56f-4edf-9eec-a27ffba5fa90";
    public static final String DNA_API_SECRET = "og7cWFOXharQSrnVJhUpLdLqvxaaQg2pocyAO2OrjUz5GC5HctzoNRgMmqzRaPSy";
    public static final String DNA_AUTH_URL = "http://id.dna.or.id/oauth/authorize";
    public static final String DNA_REQUEST_TOKEN = "http://id.dna.or.id/oauth/token";
    public static final String DNA_REQUEST_ME = "http://id.dna.or.id/1/users/me";
    public static final String DNA_CALLBACK = "midas://social_login";
    ...
    public static final int DNAID_REQUEST_ACCESS = 61;
    public static final int DNAID_REQUEST_TOKEN_TASK = 62;
    public static final int DNAID_REQUEST_ME_TASK = 63;
    public static final int DNAID_REFRESH_TOKEN_TASK = 64;

    public static final int V2ID_REQUEST_ACCESS = 71;
    public static final int V2ID_REQUEST_TOKEN_TASK = 72;
    public static final int V2ID_REQUEST_ME_TASK = 73;
    public static final int V2ID_REFRESH_TOKEN_TASK = 74;
